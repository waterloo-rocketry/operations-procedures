...
\begin{checklist}
    ...
    \item \control: Confirm that all actuator controls are in the off/closed state:
    \begin{checklist}
        \item Remote Fill Valve
        \item Line Vent Valve
    ...
    \item \primary: Arm remote disconnect by connecting the springs and fill adapter.
...
\begin{checklist}
    ...
    \item \ops: Send ``\ops{} to \secondary{}, \ops{} to \secondary{}, going to full abort. I say again, going to full abort.''
...
\begin{checklist}
    ...
    \begin{checklist}
        \item Send ``\secondary{} to \ops{}, \secondary{} to \ops{}, \ops{} please acknowledge''.
        \begin{checklist}[label=$\bullet$]
            \item If contact is restored:
            \begin{checklist}
                \item Return to normal operations.
