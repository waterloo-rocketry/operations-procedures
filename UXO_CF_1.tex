...
\operator{primary}{Plum}{PRIMARY}{Primary Fill Operator}
\operator{secondary}{cyan}{SECONDARY}{Secondary Fill Operator}
\operator{daq}{olive}{DAQ}{DAQ Technician}
...
\section{Cold Flow Test Operations Procedure}
...
\begin{checklist}
    ...
    \begin{checklist}[label=$\bullet$]
        ...
        \end{checklist}
    \end{checklist}
    \item \daq{}: Wait until the oxidizer tank mass plateaus.
    \item \primary{}: Close the Remote Fill Valve.
    \begin{checklist}[label=$\bullet$]
    ...
    \item \daq{}: Proceed only when the oxidizer tank pressure is at least 650 psi.
    \begin{checklist}[label=$\bullet$]
        \item If the oxidizer tank pressure does not reach 650 psi:
        \begin{checklist}
            ...
            \item \primary{} and \secondary: Approach the test plumbing.
            \item \primary{}: Close the Cylinder Valve.
            \item \primary{}: Slowly open the Remote Fill Valve.
            \item \daq{}: Confirm that the fill lines are fully depressurized.
            \item \ops{}: Abort test procedures and revisit plumbing setup.
        \end{checklist}
    \end{checklist}
